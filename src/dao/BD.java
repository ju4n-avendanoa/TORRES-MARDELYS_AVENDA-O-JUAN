...
public class BD {
  ...
  private static final String SQL_DROP_CREATE_ODONTOLOGOS="DROP TABLE IF EXISTS ODONTOLOGO; " + "CREATE TABLE ODONTOLOGO (ID INT NUMERO_MATRICULA PRIMARY KEY, " + "NOMBRE VARCHAR(100) NOT NULL, APELLIDO VARCHAR(100) NOT NULL)";
