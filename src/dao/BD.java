...
public class BD {
  ...
  private static final String SQL_DROP_CREATE_ODONTOLOGOS="DROP TABLE IF EXISTS ODONTOLOGO; " + "CREATE TABLE ODONTOLOGO (NUMERO_MATRICULA INT NOT NULL PRIMARY KEY, " + "NOMBRE VARCHAR(100) NOT NULL, APELLIDO VARCHAR(100) NOT NULL)";
